  ...
  return (
    <div className="max-w-7xl mx-auto my-10">
      ...
      <div className="my-4">
        ...
        <h1 className="font-bold my-1">Experience: <span className="pl-4 font-normal text-gray-800">2 YOE</span></h1>
        ...
        <h1 className="font-bold my-1">Posted Date: <span className="pl-4 font-normal text-gray-800">06-07-2025</span></h1>
      </div>
    </div>
  );
}
